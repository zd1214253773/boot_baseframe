...
/**
 * ==排序结果====>>>["1","1.1","1.1.1","1.1.2","2"]
 *
 * @author ZHENGDONG
 * @date 2020/12/9 20:00
 */
public class  NaturalOrderComparator implements Comparator<OrderFinal> {
    /*@Override
    public int compare(IndicatorManageVO o1, IndicatorManageVO o2) {
    ...
    public int compare(OrderFinal o1, OrderFinal o2) {
        ...
        int lev = Math.min(f1.length, f2.length);
